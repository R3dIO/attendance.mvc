...
function getPdf($data) {
	...
	$sub_id=$schedule['subject_id'];
	$lec_no=$schedule['last_lecture_no'];
	$month=substr($schedule['last_lecture_date'],5,2);
	$year=substr($schedule['last_lecture_date'],0,4);
